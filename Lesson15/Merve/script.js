...
const stringExercise4 = 'FUNCTIONAL PROGRAMMING EMPHASIZES PURE FUNCTIONS AND IMMUTABLE DATA.'.toLowerCase();
console.log(stringExercise4);
...
const priceAndCurrency = planPriceString.slice(startIndex, endIndex); 
