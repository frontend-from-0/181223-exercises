...
const { name: fullName, age: personE14age } = personE14;

console.log(fullName, personE14age);
...
const { name: E16fullName } = personE16; 
console.log(E16fullName);
...
const userName = userEx8?.profile?.name ?? 'Default Name';
console.log('EX8', userName);

const userCity = userEx8?.profile?.address?.city ?? 'Unknown City';
console.log('EX8', userCity);
...
const userNameEx10 = userEx10?.profile?.getName?.() ?? 'Default Name'; 
