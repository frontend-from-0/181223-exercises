...
console.log(getObjectValues({ name: 'John', age: 30, city: 'New York' }));
console.log('----------------------------');
...
console.log('Ex 10:');
console.log(addKeyValuePairToObject({ name: 'John', age: 30 }, 'city', 'New York'));
console.log('----------------------------');
...
function removeKeyValuePairFromObject(object, key) {
    delete object[key];
    return object;
}
console.log('Ex 11:');
console.log(removeKeyValuePairFromObject({ name: 'John', age: 30, city: 'New York' }, 'city'));
console.log('----------------------------');
...
console.log('Ex 12:');
console.log(arraysToObject(['name', 'age', 'city'], ['John', 30, 'New York']));