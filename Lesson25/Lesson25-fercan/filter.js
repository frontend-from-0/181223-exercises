...
const oddNumbers2 = numbersExercise1.filter(number => number % 2 !== 0);
...
const filteredWords = wordsExercise2.filter(word => !word.includes('a'));
...
const filteredBooks = booksExercise9.filter(object => object.price>=10);
...
const peopleAbove25 = usersExercise4.filter(object => object.age<=25);
console.log('Ex.4');
...
const producstInStock = productsExercise6.filter(object => object.quantity>0);
console.log('Ex.6:');
console.log(producstInStock);
...
console.log('Ex.8:');
const wordsLessThan5 = wordsExercise8.filter(word => word.length<=5);
console.log(filteredWords);
...
console.log('Ex.9:');
studentsExercise9.filter(student => student.grade[0].toUpperCase() === 
'D' || student.grade[0].toUpperCase() ==='F' || student.grade.toUpperCase() === 'C-')

//const studentsStudyMore = studentsExercise9.filter(student => student.grade<'C');
console.log(studentsStudyMore);
