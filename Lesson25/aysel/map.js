...
const toUpperCase = arr => arr.map(element => element.toUpperCase());
console.log(toUpperCase(wordsExercise1));
...
console.log(squareNumbers(numbersExercise2));
...
const numbersAsString = numbersExercise6.map(number => number.toString());
