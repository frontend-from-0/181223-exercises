...
const wordsExercise1Uppercase = wordsExercise1.map((element) => element.toUpperCase());

console.log('Initial array', wordsExercise1);
console.log('Modified array', wordsExercise1Uppercase);
// Exercise 2:
...
const arrayOfNames = products.map((object) => object.name);

console.log('Exercise3: ', arrayOfNames);
...
const wordsExercise4WordLengths = wordsExercise4.map((word) => word.length);

console.log(wordsExercise4WordLengths);
// Exercise 5:
...
const studentsExercise5NameGrade = studentsExercise5.map(student => `${student.name} ${student.grade}`);
console.log(studentsExercise5NameGrade);
...
const numbersExercise6Array = numbersExercise6.map(String);
console.log(numbersExercise6Array);
...
const sentencesExercise7ArrayOfWords = sentencesExercise7.map((sentence) => sentence.split(' '));

console.log(sentencesExercise7ArrayOfWords);
...
const booksExercise9TitlesAuthors = booksExercise9.map((books) => `${books.title} ${books.author}`);

console.log(booksExercise9TitlesAuthors);
...
const pricesExercise10CurrencySymbol = pricesExercise10.map((price => `${price} $`));

console.log(pricesExercise10CurrencySymbol);
