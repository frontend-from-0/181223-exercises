...
console.log('Exercise 1 - ', 'Odd Numbers: ', oddNumbers);
...
const containLetter = wordsExercise2.filter((word) => word.includes('a'));
console.log('Exercise 2 - ', containLetter);
...
const sentencesWith10Words = sentencesExercise5.filter((sentences) => sentences.split(' ').length <= 10);
console.log('Exercise 5 - ', sentencesWith10Words);
